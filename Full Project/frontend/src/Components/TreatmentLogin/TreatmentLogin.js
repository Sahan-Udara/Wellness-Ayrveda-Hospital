...
import './TreatmentLogin.css'; // Reusing the same styles for consistency
import Logo from "../Assets/HeroLogo.png"; // Import your logo

const TreatmentLogin = () => {
  ...
  const handleSubmit = (e) => {
    ...
    } else if (loginData.username === "treatmentadmin" && loginData.password === "12345") {
      navigate('/addtreatment'); // Navigate to AddTreatment if treatmentadmin logs in
    } else {
